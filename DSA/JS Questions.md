feat(dsa): bootstrap DSA practice section with 100+ JS questions and Node starter

* Create new DSA/ directory
* Add 2.js – simple Node.js script using prompt-sync to take user age input
* Add JS [Questions.md](http://Questions.md) – comprehensive list of 100 JavaScript exercises/questions:
  • Basic console & variables (1–20)
  • Loops & patterns (21–30)
  • Arrays (31–40)
  • Functions (41–50)
  • Conditionals (51–60, note: appears duplicated in file)
  • Objects (61–70)
  • Strings (71–80)
  • Mixed / intermediate challenges (81–100)
  • Covers DSA-adjacent topics: sorting, searching, patterns, recursion basics
