...
### 14. Working Real time communication : WebSockets and [socket.io](http://socket.io) 💬
...
* Understanding difference between WebSocket Vs [Socket.io](http://Socket.io).
* Working with `socket.io` for realtime applications.
* Understanding usage of`Rooms` in [Socket.io](http://Socket.io).
* Understanding `Middleware` in [Socket.io](http://Socket.io).
